...
public:
    ...
    {
        // CruzAzul: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // CruzAzul: get transaction coin age
...
public:
    ...
    // CruzAzul: block signature - signed by coin base txout[0]'s owner
    ...
    // CruzAzul: two types of block: proof-of-work or proof-of-stake
    ...
    // CruzAzul: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // CruzAzul: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // CruzAzul: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // CruzAzul: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // CruzAzul: block index flags
    enum  
    {
