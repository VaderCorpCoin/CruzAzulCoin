...
namespace Checkpoints
{
    ...
    // CruzAzul: synchronized checkpoint (centrally broadcasted)
    ...
    // CruzAzul: get last synchronized checkpoint
    ...
    // CruzAzul: only descendant of current sync-checkpoint is allowed
    ...
    // CruzAzul: reset synchronized checkpoint to last hardened checkpoint
...
// CruzAzul: sync-checkpoint master key
...
// CruzAzul: verify signature of sync-checkpoint message
...
// CruzAzul: process synchronized checkpoint
