...
// Copyright (c) 2014 The CruzAzul developers
...
// for both CruzAzuld and CruzAzul(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of CruzAzul releases, the client name should be selected from
