 ...
 * The CruzAzul Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("CruzAzul Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/CruzAzul_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a CruzAzul address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/CruzAzul_tooltip"), tr("&About CruzAzul"), this);
    aboutAction->setToolTip(tr("Show information about CruzAzul"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for CruzAzul"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/CruzAzul_tooltip"), tr("Show/Hide &CruzAzul"), this);
    toggleHideAction->setToolTip(tr("Show or hide the CruzAzul window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/CruzAzul_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/CruzAzul_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/CruzAzul_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("CruzAzul client"));
    trayIcon->setIcon(QIcon(":/icons/CruzAzul_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CruzAzul network", "", count));
}
